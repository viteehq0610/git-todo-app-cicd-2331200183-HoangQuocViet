...
test('End-to-end user workflow', async () => {
    ...
    let button = window.locator('#add-todo-btn');
    await button.click();
    ...
    let todoText = todoItem.locator('.todo-text');
    ...
    let todoCheckbox = todoItem.locator('input[type="checkbox"]'); 
    ...
    let deleteBtn = todoItem.locator('.delete-btn');
